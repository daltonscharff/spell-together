...
export namespace Models {
  export type public_Puzzle = {
    ...
    dateDisplay: CodecTypes['pg/text@1']['output'];
...
export declare const models: {
  public: {
    ...
    PuzzleWord: Models.public_PuzzleWord;
  };
};
